...
Feature: User Test
  ...
  Scenario: Admin should add user successfully
    ...
    And I enter User Name "Ananya77"
    And I select Status as Disable
    And I enter Password "Ananya123" in create user
    And I enter Confirm Password "Ananya123" in create User
  ...
  Scenario: User created successfully and verify it
    ...
    And I click on Admin tab
    And I should see The System Users text
    And I enter user name "Ananya23" in system users page
    And I select status as disable in system users page
    And I click on search button
    Then I should verify the user name "Ananya23" in result list
  ...
  Scenario: Admin should delete the user successfully
    ...
    And I select status as disable in system users page
    And I click on search button
    And I should verify the user name "Ananya23" in result list
  ...
  Scenario Outline: User should search and verify the message record found
    ...
    And I enter employee name "<employeeName>" in system users page
